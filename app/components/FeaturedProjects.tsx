      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row gap-6 md:gap-12 lg:gap-16 items-start">
          ...
          <motion.div 
            ...
            className="flex-1 space-y-6 md:space-y-8 lg:space-y-12"
          >
            <div>
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary/15 border border-primary/30 backdrop-blur-xl shadow-lg shadow-primary/10 mb-4 md:mb-6">
                <Code2 className="h-4 w-4 text-primary" />
                <span className="text-sm font-medium text-primary tracking-wide">DevOps Projects</span>
              </div>
              
              <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-3 md:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground/80 to-foreground/50 tracking-tight leading-tight">
                What will you ship?
              </h2>
                ...
                <Card className="group relative overflow-hidden border border-border/20 bg-background/60 backdrop-blur-xl shadow-lg hover:shadow-xl hover:shadow-primary/10 hover:border-primary/30 hover:scale-105 transition-all duration-300 ease-out rounded-2xl">
                  ...
                  <div className="p-4 md:p-6 lg:p-8 relative">
                    <div className="flex items-center gap-3 mb-4 md:mb-6">
                      <div className="size-10 md:size-12 rounded-full bg-primary/15 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div>
                        ...
                        <h3 className="text-lg md:text-xl font-semibold mt-1 group-hover:text-primary transition-colors tracking-wide">Kubernetes Deployment</h3>
                      </div>
                    </div>
                    <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6 leading-relaxed">Build a complete CI/CD pipeline with GitHub Actions, Docker, and Kubernetes.</p>
                  ...
                  <div className="p-4 md:p-6 lg:p-8 relative">
                    <div className="flex items-center gap-3 mb-4 md:mb-6">
                      ...
                      <div>
                        ...
                        <h3 className="text-lg md:text-xl font-semibold mt-1 group-hover:text-primary transition-colors tracking-wide">AWS EKS Cluster</h3>
                      </div>
                    </div>
                    <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6 leading-relaxed">Deploy a production-ready EKS cluster using Terraform and AWS best practices.</p>
                    <Button variant="ghost" className="group/btn px-0 hover:bg-transparent rounded-full">
                      <span className="text-muted-foreground group-hover:text-primary transition-colors font-medium">View Project</span>
                      <ArrowRight className="h-4 w-4 ml-2 transition-transform group-hover/btn:translate-x-0.5" />
                    </Button>
          ...
          <motion.div 
            ...
            className="w-full md:w-[400px] lg:w-[450px] space-y-4 md:space-y-6 lg:space-y-8"
          >
            <Card className="border border-border/20 bg-background/60 backdrop-blur-xl shadow-lg overflow-hidden rounded-2xl">
              <div className="p-3 md:p-4 lg:p-6 font-mono text-xs md:text-sm bg-muted/20">
