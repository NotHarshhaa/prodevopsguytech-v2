    ...
    <section className="py-16 md:py-24 px-4 overflow-hidden relative">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm mb-6">
                ...
                <span className="text-sm font-medium text-primary">DevOps Projects</span>
              </div>
            ...
            >
              <motion.div variants={fadeInUp}>
                <Card className="group relative overflow-hidden border border-border/50 bg-gradient-to-b from-background/50 to-background/80 backdrop-blur-sm shadow-md hover:shadow-lg hover:shadow-primary/5 hover:border-primary transition-all duration-300">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="p-6 md:p-8 relative">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="size-12 rounded-lg bg-primary/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Terminal className="h-6 w-6 text-primary" />
                      </div>
                      <div>
                        <span className="text-sm font-medium text-primary">CI/CD Pipeline</span>
                        <h3 className="text-xl font-semibold mt-1 group-hover:text-primary transition-colors">Kubernetes Deployment</h3>
                      </div>
                    </div>
                    <p className="text-muted-foreground text-sm mb-6">Build a complete CI/CD pipeline with GitHub Actions, Docker, and Kubernetes.</p>
                    <Button variant="ghost" className="group/btn px-0 hover:bg-transparent">
                      <span className="text-muted-foreground group-hover:text-primary transition-colors">View Project</span>
                ...
                <Card className="group relative overflow-hidden border border-border/50 bg-gradient-to-b from-background/50 to-background/80 backdrop-blur-sm shadow-md hover:shadow-lg hover:shadow-primary/5 hover:border-primary transition-all duration-300">
                  ...
                  <div className="p-6 md:p-8 relative">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <span className="text-sm font-medium text-primary">Infrastructure as Code</span>
                        <h3 className="text-xl font-semibold mt-1 group-hover:text-primary transition-colors">AWS EKS Cluster</h3>
                      </div>
                    </div>
                    <p className="text-muted-foreground text-sm mb-6">Deploy a production-ready EKS cluster using Terraform and AWS best practices.</p>
                    <Button variant="ghost" className="group/btn px-0 hover:bg-transparent">
                      <span className="text-muted-foreground group-hover:text-primary transition-colors">View Project</span>
                      <ArrowRight className="h-4 w-4 ml-2 transition-transform group-hover/btn:translate-x-1" />
                    </Button>
          ...
          >
            <Card className="border border-border/50 bg-gradient-to-b from-background/50 to-background/80 backdrop-blur-sm shadow-md overflow-hidden">
            ...
            <Card className="border border-border/50 bg-gradient-to-b from-background/50 to-background/80 backdrop-blur-sm shadow-md p-6">
              <div className="flex items-start gap-4">
                <div className="size-10 rounded-full bg-emerald-500/10 flex items-center justify-center ring-2 ring-emerald-500/20">
            ...
            <Card className="border border-border/50 bg-gradient-to-b from-background/50 to-background/80 backdrop-blur-sm shadow-md p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded-full">Healthy</span>
                </div>
                <div className="space-y-3">
                  <div>
